        ...
        */
        ...
        public int ff_set_systematic_pal2(byte[] pal /*[256]*/, int pal_offset, int pix_fmt)
        {
            ...
            for (i = 0; i < 256; i++)
            {
                ...
                //pal[i] = b + (g<<8) + (r<<16);
                pal[pal_offset + i * 4 + 0] = (byte) (b < 0 ? 0 : (b > 255 ? 255 : b));
                pal[pal_offset + i * 4 + 1] = (byte) (g < 0 ? 0 : (g > 255 ? 255 : g));
                pal[pal_offset + i * 4 + 2] = (byte) (r < 0 ? 0 : (r > 255 ? 255 : r));
                pal[pal_offset + i * 4 + 3] = 0; // alpha       
            }
